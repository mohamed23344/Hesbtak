...
export const Route = createFileRoute("/dashboard/expenses/payments")({ component: ExpensePayments });
            ...
            {payments.length === 0 ? (
              ...
              payments.map((p) => (
                <tr key={p.id} className="hover:bg-surface-subtle">
                  ...
                  <td className="p-3 text-on-surface-variant">{p.bill_id?.slice(0, 8) || "—"}</td>
