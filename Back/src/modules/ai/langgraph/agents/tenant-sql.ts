...
onboarding_responses(id, question_key, answer, created_at)
...
invoices(id, invoice_number, customer_id, issue_date, due_date, subtotal, tax_amount, total, status, account_id, related_account_id, journal_entry_id, created_by, created_at)
...
vendor_bills(id, bill_number, vendor_id nullable for expense bills, type purchase|expense, issue_date, due_date, subtotal, tax_amount, total, status, account_id, related_account_id, journal_entry_id, created_by, created_at)
...
ai_conversations(id, session_id, user_id, parent_id, question, response, created_at)
...
report_templates(id, name, description, configuration_json, created_by, created_at)
reports(id, name, report_type, configuration_json, created_by, created_at, updated_at)
scheduled_reports(id, report_id, frequency, timezone, start_date, end_date, time_of_day, next_run_at, last_run_at, status, recipients_json, delivery_methods, export_format, created_by, created_at, updated_at)
report_executions(id, report_id, scheduled_report_id, started_at, completed_at, status, file_url, file_name, content_type, file_data, export_format, result_json, email_status, emailed_at, error_message)
`.trim();
